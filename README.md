...
* 送信後、tableViewが自動でリロードされ、追加・更新が行われていることがわかります。追加したフィールドは後から編集することが可能です
...
### 8.別のユーザー情報を取得する
* 左上の__`Logout`__ ボタンをタップするとログアウトし、元の画面に戻ります
* 別の`User Name`と`Password`を入力して![画像11](/readme-img/011.png)ボタンをタップします<br>
 (別のユーザー情報がない場合は新しくSingUpしてください)
* ログインが成功すると、先ほどとは別のユーザー情報の一覧が表示されます
